...
- `v0.13.0-Beta.html`: snapshot requerido por el service worker activo.
- `manifest-v0.13.0-beta.webmanifest`: manifiesto PWA activo.
- `sw-v0.13.0-beta.js`: service worker activo.
