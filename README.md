...
- Versión activa: **v0.13.3-Beta-Patch**
- Canal: **Beta**
...
- `v0.13.3-Beta-Patch.html`: snapshot requerido por el service worker activo.
- `manifest-v0.13.3-beta-patch.webmanifest`: manifiesto PWA activo.
- `sw-v0.13.3-beta-patch.js`: service worker activo.
